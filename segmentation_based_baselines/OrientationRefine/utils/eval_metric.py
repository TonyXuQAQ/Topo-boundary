...
predicted_segmentation_dir = './records/refine/test/refined_seg'
predicted_skel_dir = './records/refine/test/skeleton'
baseline_name = 'OrientationRefine'
predicted_graph_dir = './records/refine/test/graph'
